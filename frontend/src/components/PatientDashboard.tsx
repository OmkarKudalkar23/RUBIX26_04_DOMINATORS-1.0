  ...
  const getPredictionFields = (type: "heart" | "diabetes" | "kidney" | "sepsis") => {
    switch (type) {
      ...
      case "kidney":
        return [
          { name: "bloodPressure", label: "Blood Pressure (mm Hg)", type: "number", placeholder: "80" },
          { name: "albumin", label: "Albumin", type: "select", options: ["Normal", "Abnormal"] },
          { name: "sugar", label: "Sugar", type: "select", options: ["Normal", "Abnormal"] },
          { name: "redBloodCells", label: "Red Blood Cells", type: "select", options: ["Normal", "Abnormal"] },
          { name: "pusCells", label: "Pus Cells", type: "select", options: ["Normal", "Abnormal"] },
          { name: "hemoglobin", label: "Hemoglobin (g)", type: "number", placeholder: "15.0", step: "0.1" },
          { name: "creatinine", label: "Creatinine (mEq/L)", type: "number", placeholder: "1.2", step: "0.1" },
          { name: "sodium", label: "Sodium (mEq/L)", type: "number", placeholder: "140", step: "0.1" },
          { name: "potassium", label: "Potassium (mEq/L)", type: "number", placeholder: "4.5", step: "0.1" },
          { name: "hypertension", label: "Hypertension", type: "select", options: ["Yes", "No"] },
          { name: "diabetesHistory", label: "Diabetes History", type: "select", options: ["Yes", "No"] }
        ];
      case "sepsis":
        return [
